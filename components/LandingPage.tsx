...
import { PRESET_PERSONAS, MOODS, COMMON_LANGUAGES } from '../constants';
          ...
          <div className="flex-1">
            {!hasKey ? (
              <div className="h-full flex flex-col justify-center items-center text-center p-6 space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-bold mb-2">Initialize Neural Key</h3>
                  <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
                    To access real-time voice coaching, you must link an API Key from a paid Google Cloud project.
                  </p>
                </div>
                <button 
                  onClick={handleSetupKey}
                  className="w-full py-4 bg-blue-600 rounded-xl font-bold text-lg hover:bg-blue-500 transition-all shadow-lg shadow-blue-500/25"
                >
                  Configure Link
                </button>
                <a 
                  ...
                  className="text-[10px] text-slate-500 uppercase tracking-widest font-black hover:text-blue-400 transition-colors"
                >
                  Learn about billing →
                </a>
              </div>
